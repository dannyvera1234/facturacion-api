...
public class ValueInvoiceResponseDTO implements Serializable {
	...
	public ValueInvoiceResponseDTO() {
		super();
	}

	public ValueInvoiceResponseDTO(Long ide, double subtIvaActual, double subtIvaCero, double subtNoObjIva,
